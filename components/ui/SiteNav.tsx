        ...
        <div className="flex items-center justify-end md:justify-between h-full px-4">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            ...
            <Link
              href="/store"
              prefetch={false}
              className="ios-press flex items-center gap-1.5 rounded-full border border-accent-candle/30 bg-accent-candle/10 h-9 px-3 text-[13px] font-medium text-accent-candle transition-all hover:bg-accent-candle/20 focus-visible:ring-2 ring-line-focus"
            >
              <CoinIcon className="w-3.5 h-3.5" />
              <span>+10 coins today</span>
            </Link>
          </div>
        ...
        <div className="px-4 pb-4 flex-1">
          ...
          <div className="ios-card overflow-hidden mb-3">
            ...
            >
              ...
              <span className="text-[15px] flex-1 text-left text-[var(--ios-text-secondary)]">More</span>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--ios-text-tertiary)] flex-shrink-0 transition-transform" style={{ transform: moreOpen ? "rotate(90deg)" : "rotate(0deg)" }}>
                <path d="M9 18l6-6-6-6" />
              </svg>
            </button>
            {moreOpen && MORE_GROUP.map((item) => (
              <SidebarRow key={item.label} item={item} active={isActive(item.href)} />
            ))}
          </div>
        </div>

        {/* Bottom: Profile + SweetScene info */}
        <div className="px-4 pb-4 border-t border-[var(--ios-hairline)] pt-3">
          ...
          <div className="px-3 pt-2 pb-1">
            <p className="text-[11px] text-[var(--ios-text-tertiary)] leading-relaxed">
              ...
              <span className="font-mono">16+ platform to join</span>
            </p>
          </div>
        </div>
      </aside>
