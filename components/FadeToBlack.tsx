        ...
        <>
          ...
          <div className="mt-8">
            <button
              ...
              className="bg-gradient-to-r from-brand-dark to-crimson-600 text-white font-medium px-8 py-3 rounded-xl hover:from-brand hover:to-crimson-500 active:scale-95 transform transition-all duration-300 text-sm"
            >
    ...
    return (
      <>
        ...
        <button
          ...
          className="bg-gradient-to-r from-brand-dark to-crimson-600 text-white font-medium px-8 py-3 rounded-xl hover:from-brand hover:to-crimson-500 active:scale-95 transform transition-all duration-300 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          {!isAiMatch && (
            <div className="flex flex-col items-center gap-1">
              <button
                type="button"
                onClick={onReveal}
                className="px-8 py-4 rounded-xl font-medium text-base text-white bg-gradient-to-r from-brand-dark to-crimson-600 hover:from-brand hover:to-crimson-500 active:scale-95 transform transition-all duration-300"
              >
                Reveal Myself
              </button>
