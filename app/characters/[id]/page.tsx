      ...
      <main className="relative z-0 max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-8">
          <Link
            ...
            className="text-center flex-1 bg-gradient-to-r from-brand-dark to-crimson-600 text-white font-medium py-3 rounded-xl hover:from-brand hover:to-crimson-500 active:scale-95 transform transition-all"
          >
            ▶ Play Solo
          </Link>
          {isOwner && (
