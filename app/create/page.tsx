    ...
    <main className="min-h-screen bg-void-950 text-white px-4 sm:px-6 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit" disabled={!name || !tagline || !personality || !openingLine}
            className="w-full px-6 py-3.5 rounded-xl font-medium text-white bg-gradient-to-r from-brand-dark to-crimson-600 hover:from-brand hover:to-crimson-500 active:scale-95 transform transition-all disabled:opacity-50 disabled:cursor-not-allowed pulse-glow">
            Publish Character
          </button>
        </form>
      </div>
