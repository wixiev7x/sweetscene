      ...
      <section className="py-24 px-6 bg-void-900">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {STEPS.map((step, i) => (
            <div
              key={step.title}
              className="bg-surface border border-white/10 rounded-2xl p-8 text-center hover:border-neon-magenta/40 transition-all duration-300"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {SCENARIOS.map((s, i) => (
            <Link
              key={s.name}
              href="/scenarios"
              className="group bg-surface border border-white/10 rounded-2xl p-6 hover:border-neon-magenta/40 hover:bg-surface-raised transition-all duration-300"
      ...
      <section className="py-24 px-6 bg-void-900">
        ...
        <div className="max-w-2xl mx-auto space-y-3">
          {ACTIVITY.map((item, i) => (
            <div
              key={i}
              className="flex items-center gap-4 bg-surface border border-white/10 rounded-xl px-5 py-4"
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {FEATURES.map((f, i) => (
            <Link
              key={f.title}
              href={f.href}
              className="group bg-surface border border-white/10 rounded-2xl p-8 hover:border-neon-magenta/40 hover:bg-surface-raised transition-all duration-300"
              style={{ animation: "slowFade 2s ease-in-out forwards", animationDelay: `${0.1 + i * 0.1}s`, opacity: 0 }}
            >
