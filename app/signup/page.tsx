...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-void-950 text-white flex items-center justify-center px-6">
      ...
      <div className="relative z-10 w-full max-w-sm bg-surface/50 border border-white/10 rounded-3xl p-8 flex flex-col items-center text-center">
        ...
        {pending && <p className="text-xs text-muted mt-4">Redirecting…</p>}
