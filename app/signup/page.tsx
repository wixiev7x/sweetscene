      ...
      <div className="relative z-10 w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 flex flex-col items-center text-center">
        ...
        <label className="flex items-start gap-2 w-full text-left cursor-pointer mt-4">
          ...
          <span className="text-xs text-muted leading-relaxed">
            I agree to the{" "}
            <a href="/legal/terms" className="text-brand-light hover:text-brand-lighter underline">Terms of Service</a>{" "}
            and{" "}
        ...
        <p className="text-xs text-muted mt-6">
          ...
          <Link href="/login" className="text-brand-light hover:text-brand-lighter underline">Welcome back.</Link>
        </p>
      </div>
    </div>
  );
